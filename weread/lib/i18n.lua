...
local zh = {
    ...
    ["Private edition · Updates from %1"] = "私人版 · 更新源：%1",
    ...
    ["Update check failed:\n%1"] = "检查更新失败：\n%1",
    ["Unknown error"] = "未知错误",
    ["The public-account credential expired. Scan the WeRead QR code again."] = "公众号凭证已过期，请重新扫描微信读书登录二维码。",
    ["WeRead requires a security verification. Complete it in WeRead or the WeRead web reader, then retry."] = "微信读书要求安全验证。请先在微信读书 App 或网页版阅读器中完成验证，再重试。",
    ["WeRead temporarily limited public-account requests. Stop retrying for a while, then renew the cookie and try again."] = "微信读书暂时限制了公众号请求。请停止重试并等待一段时间，然后续期 Cookie 再试。",
    ...
    ["EPUB packaging is finishing; please wait."] = "EPUB 正在完成打包，请稍候。",
    ["EPUB packaging subprocess returned no result."] = "EPUB 打包子进程没有返回结果。",
    ["EPUB packaging timed out."] = "EPUB 打包超时。",
    ["Not enough free space to build the EPUB. Need about %1 MB more free space."] = "可用空间不足，无法生成 EPUB；还需要约 %1 MB 空间。",
    ...
    ["Running"] = "运行中",
    ["Stopped"] = "已停止",
    ["Waiting for verified reading progress"] = "等待阅读进度校验",
    ["Waiting for network"] = "等待网络连接",
    ["Waiting for next report"] = "等待下次上报",
    ["Suspended"] = "已挂起",
    ["Error"] = "错误",
    ...
    ["Cache cleared"] = "缓存已清除",
    ["Cache cleanup was refused:\n%1"] = "为保护目录安全，缓存清理已被拒绝：\n%1",
    ["Public account cache was partly cleared; %1 unsafe item(s) were kept."] = "公众号缓存已部分清除；%1 个无法确认归属的项目已保留。",
    ["Cache was partly cleared; %1 unsafe item(s) were kept."] = "缓存已部分清除；%1 个无法确认归属的项目已保留。",
