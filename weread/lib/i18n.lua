...
local zh = {
    ...
    ["Show local-book underlines"] = "显示本地书划线",
    ...
    ["Matched with “%1”.\n\nSync underlines and thoughts now?"] = "已匹配《%1》。\n\n是否立即同步划线和想法？",
    ...
    ["Sync cancelled. Downloaded chapters were saved and will resume next time."] = "同步已取消，已下载章节已经保存，下次将继续同步。",
    ["Underlines and thoughts sync was interrupted:\n%1\n\nDownloaded chapters were saved. Retry to continue."] = "划线和想法同步中断：\n%1\n\n已下载章节已经保存，重试即可继续。",
    ...
    ["Clear match and annotation data"] = "清除匹配及标注数据",
    ...
    ["Overlay metrics: %1 candidate(s), %2 box(es), %3 ms"] = "标注层指标：%1 条候选，%2 个矩形，%3 毫秒",
    ["Thoughts"] = "想法",
