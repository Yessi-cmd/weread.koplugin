...
- If menu items are added, removed, renamed, or moved, update `ui/menu.lua`, `lib/i18n.lua`, and the README menu tree together.
...
- 如果新增、删除、重命名或移动菜单项，需要同时更新 `ui/menu.lua`、`lib/i18n.lua` 和 README 菜单结构。
